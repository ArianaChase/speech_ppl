...
python $root_dir/src/metrics/metrics_synth_B.py \
	--root_dir $root_dir \
	...
	--metadata $root_dir/src/stim_final/setC_stimuli_list.csv \
	...
	--evaluation_dir $root_dir/work/outputs/cosyvoice/test_B \
	--set_name $set_name